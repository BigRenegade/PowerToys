...
import powertoys.gui.server.SlotExtractList;
...
public class GuiExtractPort extends GuiContainerPR {

	public static final ResourceLocation extractGuiTextures = new ResourceLocation(Reference.MODID, "textures/gui/extract_port.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String string = PRBlocks.extract_port.getLocalizedName();
