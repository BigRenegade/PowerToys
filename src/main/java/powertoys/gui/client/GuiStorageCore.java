...
import powertoys.util.PRItemRenderer;
...
public class GuiStorageCore extends GuiContainerPR {
	...
	private static final ResourceLocation sortGui = new ResourceLocation(Reference.MODID, "textures/gui/custom_gui.png");
...
//		}
	...
	private void updateFilteredItems() {
		...
		while (iterator.hasNext()) {
			...
			if (oreSearch) { // searches oredict entries
				...
				compare2 = PRStorageUtils.getModNameFromID(compare).toLowerCase();
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		...
		if (slot != null) {
			...
			PowerToys.nw.sendToServer(new MessageCustomClick(index, mouseButton, mode));
	...
	protected ResourceLocation getBackground() {
		return new ResourceLocation(Reference.MODID + ":textures/gui/storage_scroll_gui.png");
	}
