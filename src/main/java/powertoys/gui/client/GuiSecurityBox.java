...
import powertoys.tileentity.TileEntitySecurityBox.SecurePlayer;
...
public class GuiSecurityBox extends GuiContainerPR {

	public static final ResourceLocation secureGuiTextures = new ResourceLocation(Reference.MODID, "textures/gui/security_box.png");
	...
	public void initGui() {
		...
		nearbyPlayers = PRStorageUtils.getNearbyPlayers(tileSecure.getWorld(), tileSecure.getPos(), 32, nButtons);
	}
	...
	protected void actionPerformed(GuiButton parButton) {
		...
		if (parButton.id < nButtons) {
			...
			PRNetwork.sendSecurePlayerMsg(tileSecure.getWorld(), tileSecure.getPos(), new SecurePlayer(nearbyPlayers.get(parButton.id - nButtons)),
					true);
		}
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		String string = PRBlocks.security_box.getLocalizedName();
