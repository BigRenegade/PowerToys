...
public class SecurityOverrideHelper {
	...
	public static void sendOpNotification(EntityPlayerMP op, List<SecurePlayer> securePlayers) {
		String to = "Operator " + op.getName() + " has overridden your " + Reference.MODNAME + " system lockout.";
		String from = "You have overridden the lockout to the " + Reference.MODNAME + " system owned by " + securePlayers.get(0).name + ".";
