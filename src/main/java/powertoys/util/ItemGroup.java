...
public class ItemGroup {
	...
	public static class CountComparator extends ItemGroupComparator {
		...
		public int compare(ItemGroup group1, ItemGroup group2) {
			...
			if (l1 != l2) {
				...
				String n1 = PRStorageUtils.getStackDisplayName(group1.itemStack);
				String n2 = PRStorageUtils.getStackDisplayName(group2.itemStack);
	...
	public static class ModNameComparator extends ItemGroupComparator {
		...
		public int compare(ItemGroup group1, ItemGroup group2) {
			...
			String n1 = PRStorageUtils.getModNameFromID(m1).toLowerCase();
			String n2 = PRStorageUtils.getModNameFromID(m2).toLowerCase();
			if (!n1.equals(n2)) {
				return n1.compareTo(n2);
			} else {
				Long l1 = group1.count;
