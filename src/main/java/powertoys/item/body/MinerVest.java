...
public class MinerVest extends PRItem implements IBauble
{
	@GameRegistry.ObjectHolder(Reference.MINERVEST)
	public static final Item RING = null;

	public MinerVest(String name)
	{
		super(name);
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0)
			...
			player.addPotionEffect(new PotionEffect(MobEffects.HASTE,20*60,0,true,false));
		}
	}
