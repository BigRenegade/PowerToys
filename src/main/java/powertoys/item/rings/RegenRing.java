...
public class RegenRing extends PRItem implements IBauble
{
	@GameRegistry.ObjectHolder(Reference.REGENERATIONRING)
	public static final Item RING = null;

    public RegenRing(String name)
	{
		super(name);
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0)
			...
			{
				player.addPotionEffect(new PotionEffect(MobEffects.REGENERATION,20*60,0,true,false));
			}
	}
