...
public class LavaWalkerRing extends PRItem implements IBauble
{
	@GameRegistry.ObjectHolder(Reference.LAVAWALKERRING)
	...
	public LavaWalkerRing(String name)
	{
		super(name);
