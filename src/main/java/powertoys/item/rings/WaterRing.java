...
public class WaterRing extends PRItem implements IBauble
{
	@GameRegistry.ObjectHolder(Reference.WATERRING)
	public static final Item RING = null;
	private static final String name = "WaterRing";

    public WaterRing(String name)
	{
		super(name);
